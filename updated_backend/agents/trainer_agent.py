    ...
    def process_request(self,emergency_type, feedback_reports=None): # input: emergency type
        ...
        if feedback_reports:
            ...
            input_text = f"""
                ...
                ## Output Format:
                - A short, **2-3 paragraph** narrative describing the setting, the caller's emotional state, and the situation that prompts the call.
                - Focus on the crucial protocol steps the dispatcher must take.
            ...
            input_text = f"""
                ...
                ## Output Format:
                - A short, **2-3 paragraph** narrative describing the setting, the caller's emotional state, address and the situation that prompts the call.
                - Focus on the crucial protocol steps the dispatcher must take.
